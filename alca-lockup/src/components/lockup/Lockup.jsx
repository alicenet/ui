                ...
                <Grid.Row>
                    <Header>
                        ...
                        <Header.Subheader className="mt-3">
                            ...
                            ? (`You currently have a staked position of ${formatNumberToLocale(stakedPosition.stakedAlca)} ALCA, a lockup will be a period of 6 months with 5X multiplayer (TBD)`)
                            : (`You have Locked-up ${formatNumberToLocale(lockedPosition.lockedAlca)} ALCA for 6 months 5X multiplayer (TBD)`)}
                        </Header.Subheader>
                    </Header>
