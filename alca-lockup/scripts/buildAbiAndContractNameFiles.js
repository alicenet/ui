 ...
 * @param {*} arg
 */
module.exports.buildAbiAndContractNameFiles = async function buildAbiFiles() {
    ...
    console.log("\x1b[1;32mABIs and CONTRACT_NAMES Successfully Parsed to ES6 Syntax in src/config/\n\x1b[0m");
};
