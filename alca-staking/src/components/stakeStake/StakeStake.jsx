...
export function StakeStake() {
    ...
    function renderMessage() {
        ...
        return (
            <Header className="mt-6">
                <div className="mb-4 text-base">{status?.message}</div>

                <Header.Subheader>
                    <p>You can check the transaction hash below</p>
                    <p>
                        {hash}
                        <Icon name="copy" className="cursor-pointer" onClick={() => utils.string.copyText(hash)} />
                    </p>
                </Header.Subheader>
            </Header>
        );
    ...
    function renderLockNftButton(text) {
        ...
        return <Button content={text} secondary onClick={handleLocking} />;
    }
    ...
    function renderRetryLockNftButton() {
        ...
        return (
            <div>
                ...
                <div className="mt-3">{renderLockNftButton("Retry Lock My Stake")}</div>
            </div>
        );
    }
    ...
    return (
        <>
            ...
            <Grid padded>
                ...
                <Grid.Column width={16}>{renderStaking()}</Grid.Column>
